...
void SendPrepare(Radio_Normal_Format Send)
{
    ...
    case 0:
        ...
        rt_sprintf(radio_send_buf, "{%08ld,%08ld,%03d,%02d,%d}", Send.Taget_ID, Self_ID, Send.Counter, Send.Command,
                Send.Data);
        ...
        break;
    case 1: //Sync
        rt_sprintf(radio_send_buf, "A{%02d,%02d,%08ld,%08ld,%08ld,%03d,%02d}A", Send.Ack, Send.Command, Gateway_ID,
                Self_ID, Send.Payload_ID, Send.Rssi, Send.Data);
        wifi_communication_blink();
        break;
    case 2: //Warn
        rt_sprintf(radio_send_buf, "B{%02d,%08ld,%08ld,%08ld,%03d,%03d,%02d}B", Send.Ack, Gateway_ID, Self_ID,
                Send.Payload_ID, Send.Rssi, Send.Command, Send.Data);
        wifi_communication_blink();
        break;
    case 3: //Control
        rt_sprintf(radio_send_buf, "C{%02d,%08ld,%08ld,%08ld,%03d,%03d,%02d}C", Send.Ack, Gateway_ID, Self_ID,
                Send.Payload_ID, Send.Rssi, Send.Command, Send.Data);
        wifi_communication_blink();
        break;
    }
